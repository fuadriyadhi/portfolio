    ...
    <>
      <section id="Homee" className="min-h-screen w-screen">
        <div className="parents flex flex-wrap min-h-screen min-w-full">
          {/* Container 1 */}
          <div className="one flex-1 min-w-[200px] flex flex-col justify-center items-end lg:pb-[13rem] sm:pb-0">
            <div className="card flex flex-col gap-4" data-aos="fade-left" data-aos-duration="5000" data-aos-delay="50">
              ...
              <div className="card-2 font-light text-[15px] w-full max-w-[230px] h-[100px] flex flex-col justify-center items-end p-4">
          ...
          {/* Container 2 */}
          <div className="two flex-1  p-4 min-w-[200px] flex items-center justify-center">
            <div className="two_c relative w-full max-w-[500px] lg:top-[80px]">
              {/* Foto me dengan z-index lebih tinggi */}
              <img src={me} alt="foto saya" data-aos="zoom-in" data-aos-duration="5000" className="w-full h-auto z-10 relative" />
              {/* Foto circle di bawah */}
              <img src={cirle} alt="bulat" className="cssanimation pushReleaseFromBottom absolute top-0 left-0 w-full h-auto z-0" />
            </div>
          </div>

          {/* Container 3 */}
          <div className="three flex-1  p-4 min-w-[200px] flex flex-wrap items-center justify-center">
            <div data-aos="fade-right" data-aos-duration="5000" data-aos-delay="50" className="three-c w-full lg:max-w-[400px] flex flex-col gap-8">
