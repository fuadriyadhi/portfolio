...
export default function Skill() {
  return (
    <>
      <div className="about h-[100vh] w-full">
        <div className="flex flex-col justify-center items-center">
          <div data-aos="fade-up" data-aos-duration="1000">
            <h1 className="font-bold text-[38px] w-[600px] pt-[70px] capitalize text-center">Skill & Experience</h1>
          </div>
        </div>
        <div className="container flex justify-items-start ml-[300px] gap-[80px]">
          <div className="OrbitingCircler">
            <OrbitingCircle />
          </div>
          <div className="experience flex flex-col mt-16">
            <div className="exp-1">
