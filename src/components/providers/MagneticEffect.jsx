...
export default function ContactForm() {
  ...
  return (
    <div ref={el} className="mx-auto mb-12 flex w-full max-w-[90rem] flex-col gap-3 text-4xl">
      <form
        ref={formEl}
        action={async function (formData) {
          await formAction(formData);

          if (errors.email === false && errors.name === false && errors.message === false && errors.subject === false) {
      ...
      >
        <div className="group">
          ...
          {errors.name && <span className="block text-sm font-light text-red-500 lg:text-base">Please enter a valid name</span>}
        </div>
        <div className="group">
          <div className="relative overflow-hidden">
            <input
          ...
          {errors.email && <span className="block text-sm font-light text-red-500 lg:text-base">Please enter a valid email address</span>}
        </div>
        <div className="group">
          <div className="relative overflow-hidden">
            <input
          ...
          {errors.email && <span className="block text-sm font-light text-red-500 lg:text-base">Please enter a valid subject</span>}
        </div>
        <div className="group">
          <div className="relative overflow-hidden">
            <textarea
          ...
          {errors.message && <span className="block text-sm font-light text-red-500 lg:text-base">Please enter a message atleast 3 characters long</span>}
        </div>
        <Button aria-disabled={pending} variant="outline" size="lg" className="mt-6">
          <MagneticEffect>
            {pending === true ? (
